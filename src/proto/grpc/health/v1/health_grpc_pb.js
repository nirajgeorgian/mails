...
var proto_grpc_health_v1_health_pb = require('../../../../proto/grpc/health/v1/health_pb.js');

function serialize_grpc_health_v1_HealthCheckRequest(arg) {
  if (!(arg instanceof proto_grpc_health_v1_health_pb.HealthCheckRequest)) {
...
function deserialize_grpc_health_v1_HealthCheckRequest(buffer_arg) {
  return proto_grpc_health_v1_health_pb.HealthCheckRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_grpc_health_v1_HealthCheckResponse(arg) {
  if (!(arg instanceof proto_grpc_health_v1_health_pb.HealthCheckResponse)) {
...
function deserialize_grpc_health_v1_HealthCheckResponse(buffer_arg) {
  return proto_grpc_health_v1_health_pb.HealthCheckResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var HealthService = exports.HealthService = {
  check: {
    ...
    requestType: proto_grpc_health_v1_health_pb.HealthCheckRequest,
    responseType: proto_grpc_health_v1_health_pb.HealthCheckResponse,
